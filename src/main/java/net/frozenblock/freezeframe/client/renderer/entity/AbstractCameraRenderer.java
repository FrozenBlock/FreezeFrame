...
import net.frozenblock.freezeframe.client.model.object.camera.AbstractCameraModel;
...
public abstract class AbstractCameraRenderer<T extends TripodCamera, M extends AbstractCameraModel> extends MobRenderer<T, TripodCameraRenderState, M> {

	public AbstractCameraRenderer(EntityRendererProvider.Context context, M model, float shadow) {
	...
	@Override
	public void extractRenderState(T entity, TripodCameraRenderState renderState, float partialTicks) {
		super.extractRenderState(entity, renderState, partialTicks);
		renderState.trackedHeight = entity.getTrackedHeight();
		renderState.timer = entity.getTimer(partialTicks);
