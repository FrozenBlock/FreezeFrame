...
package net.frozenblock.freezeframe.data.tag;
...
public final class FFItemTagsProvider extends FabricTagsProvider.ItemTagsProvider {

	public FFItemTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
	...
	protected void addTags(HolderLookup.Provider arg) {
		this.builder(FFItemTags.CAMERAS)
			.add(FFItemIds.CAMERA, FFItemIds.DISC_CAMERA);
	}
}
