...
package net.frozenblock.freezeframe.mixin.film;

import net.frozenblock.freezeframe.item.FilmItem;
import net.frozenblock.freezeframe.menu.impl.ContainerMenuFilmInterface;
...
public class AbstractContainerMenuMixin implements ContainerMenuFilmInterface {
	...
	@Unique
	@Override
	public void freezeFrame$setSelectedFilmPhotographIndex(int slotIndex, int selectedPhotographIndex) {
