...
public final class ScopeItemHelper {
	...
	public static boolean isCameraItem(ItemStack itemStack) {
		return itemStack.is(FFItemTags.CAMERAS);
	}

	public static boolean isScopeItem(ItemStack itemStack) {
		return ScopeZoomHelper.isScopeItem(itemStack);
	}
