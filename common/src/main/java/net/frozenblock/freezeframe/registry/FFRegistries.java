...
public final class FFRegistries {
	...
	public static void init() {
		if (ModLoader.isClient()) {
			RegistryHelper.registerSyncedDynamicRegistry(SPECIAL_FILM_FILTER, SpecialFilmFilter.Client.CODEC);
		} else {
			RegistryHelper.registerSyncedDynamicRegistry(SPECIAL_FILM_FILTER, SpecialFilmFilter.CODEC);
		}
	}

	private FFRegistries() {}
}
